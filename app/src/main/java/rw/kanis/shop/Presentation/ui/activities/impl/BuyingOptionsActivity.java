...
import rw.kanis.shop.Models.ChoiceOption;
...
import rw.kanis.shop.Presentation.presenters.BuyingOptionPresenter;
import rw.kanis.shop.Presentation.ui.activities.BuyingOptionView;
import rw.kanis.shop.Presentation.ui.customui.MyRadioButton;
    ...
    private void processAddToCart(){
        ...
        if(authResponse != null && authResponse.getUser() != null){
            if (variantResponse != null && variantResponse.getInStock()){
                ...
                CustomToast.showToast(BuyingOptionsActivity.this, "Colour or Size may not be Selected or Available.", R.color.colorWarning);
            }
        }
        else {
