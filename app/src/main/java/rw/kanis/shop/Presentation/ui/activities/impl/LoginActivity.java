...
import rw.kanis.shop.Presentation.presenters.LoginPresenter;
...
public class LoginActivity extends BaseActivity implements LoginView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                CustomToast.showToast(LoginActivity.this, "Login Successful", 1);
            }
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            // Signed rw successfully, show authenticated UI.
    ...
    public void setLoginResponse(AuthResponse authResponse) {
        if(authResponse != null) {
            ...
            //   CustomToast.showToast(this, authResponse.getMessage(), R.color.colorSuccess);
            Intent returnIntent = new Intent();
            setResult(Activity.RESULT_OK, returnIntent);
            CustomToast.showToast(this , "Logged-In Successfully !",1);
            finish();
        }else{
            CustomToast.showToast(this , "Incorrect Credentials !!!" , R.color.colorSuccess);
        }
    }
}
